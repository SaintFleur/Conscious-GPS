...
def find_biggest_contour(image):
	...
	if not contour_sizes:
		print("No Contours in this image")
		return None, None
	else:
...
def draw_bus_stop(image):
	...
	#Green Range
	min_color=np.array([50,80,130])
	max_color=np.array([100,120,200])

	mask1=cv2.inRange(image_blur_hsv,min_color,max_color)

	#Red Range
	min_color2=np.array([160,200,130])
	max_color2=np.array([190,256,200])
	...
	#Purple Range
	min_color4=np.array([135,140,130])
	max_color4=np.array([160,180,200])
...
def calculateXDistance(image):
	...
	if(contour is None):
		print("Distance cannot be found")
		return None, None
